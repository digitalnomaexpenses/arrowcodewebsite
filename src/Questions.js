...
export default function Questions(props) {
	return(
		<div className="container pt-5">
			<div className={props.darkMode ? "questions d-flex flex-row pt-5 ps-5 pe-5 pb-3 dark": "questions d-flex flex-row pt-5 ps-5 pe-5 pb-3 light"}>
				<div className="col-5 pe-4">
					<div className="d-flex flex-column">
						<div className="questions-heading pb-4">Have <span>Questions?</span></div>
						<div className="questions-text pb-4">Have a question that we haven’t covered yet?</div>
						<div className="ps-5 pe-5 pt-5 ms-4">
				...
				<div className="col">
					<div className="accordion accordion-flush" id="accordionFlushExample">
						...
						<div className={props.darkMode ? "accordion-item dark-accordion" : "accordion-item"} style={{background: props.darkMode ? "#303030" : "rgba(255, 255, 255, 1)"}}>
