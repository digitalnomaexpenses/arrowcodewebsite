		...
		<div className="container pt-5">
			<div className={props.darkMode ? "questionsMobile dark": "questionsMobile light"}>
				<div className="d-flex flex-column pt-5 pb-5 ps-4 pe-4">
					<div className="questions-heading-mobile pb-3 text-center">Have <span>Questions?</span></div>
					<div className="questions-text-mobile pb-4 text-center">Have a question that we haven’t covered yet?</div>
					<div className="text-center pt-3">
						<button className="questions-buttonMobile" href="#">Contact Us</button>
					</div>
					<div className="questions-svg-div text-center ps-5 pb-3">
